...
\paragraph{Alcance de estos resultados.} Las cifras de rendimiento anteriores comparan conexiones a tres nodos pertenecientes al mismo clúster; no constituyen todavía la comparación requerida entre un clúster distribuido y una instancia independiente de nodo único. Por tanto, aún no se calcula el factor de mejora exigido por la rúbrica. La prueba controlada sí demuestra continuidad de lectura frente a la caída de un nodo y documenta su reinicio, pero el video continuo y las mediciones repetidas de recuperación deberán conservarse como evidencias complementarias del experimento.
